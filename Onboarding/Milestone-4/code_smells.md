...
- Pure functions are easy to test, so logic issue get caught earlier. Sample text. Some more sample text. Made even more changes. More text changes. Even more text changes.
